...
## Considering the data needs of our researchers

- "As a researcher, I wish that I had access to...":
  - Data on demand (expedience)
  - Quality checks and validation performed on data
  - Ability to share analysis with collaborators
...
1. **Accelerate Innovation**<br />
  ...
  - Like adding a new team member to your research team
...
:construction: Check the version you have and see what new versions are available :construction:
```{r}
