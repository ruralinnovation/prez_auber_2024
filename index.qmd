...
- These datasets are voluminous, involving hundreds of files
- FCC releases lack "guard rails" in terms of data quality and consistency.
- Analysis of the National Broadband Map (NBM) data reveals inconsistencies:
...
::: {.notes}
Source of truth in terms of broadband data:
- Agency in charge of regulating “everything” telco (... mostly; see [NTIA](https://www.ntia.gov/page/about-ntia){.external target="_blank"})
- The agency collects and publishes data that is used as the basis for BIG infrastructure investments _and_ approval of federal + state funding awards
...
#### FCC provides data on ISP's since 2014, but:
...
::: {.notes}
In addition to publishing very meager change logs (based on CostQuest’s pre-release/proprietary updates), issues include multiple encodings, erroneous values, and limited quality control
:::
...
##  Northeast Kingdom: only 11.5% of locations have fiber access in the Northeast Kingdom
...
![](assets/images/nek_broadband_fiber_service.png)
...
## How competitive are Ohio broadband providers?
