...
#### **Challenge**: Build an infrastructure that allows us to **capitalize** on our work?
...
- Any change in the business/research needs (i.e., "We need ISP footprints" / "We should exclude locations with bad latency"):
  - ->  required another cycle to ingest/load/transform: lack of **reactivity**
...
1. Download data from FCC (see previous example)

2. Download raw data from CORI (NBM / Form 477): Ingesting CSV still cost time!
...
2. Facilitate the access to primary data to researchers, regional economists:  CORI's goals to provide rural community with good internet and change narrative about Rural place.
...
- How the data was processed? -> [Articles](https://ruralinnovation.github.io/cori.data.fcc/articles/NBM.html) and [`data-raw/`](https://github.com/ruralinnovation/cori.data.fcc/tree/main/data-raw)

- What are the news change? -> Versions / updates with a [Changelog](https://ruralinnovation.github.io/cori.data.fcc/news/index.html) 
...
- Functions designed to get data and load it in your environement  

- Code tested against github runner: it does not just work on my computer! 
...
- Place of business logic in primary data? When should we integrate it? 

- Opinion: if something related to business logic is needed it can be added 
