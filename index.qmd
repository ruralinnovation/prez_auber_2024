...
- 2 **voluninous** datasets are providing an overview of broadband access since 2014

- Data is multiples files (csv), tabular format and no "road safety barriers"
...
2. Added benefits: lower cost, less contraintes on permissions -> share it!
...
- data as code:
  ...
  * Is packaging primary still count has working primary data 
