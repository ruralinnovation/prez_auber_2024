...
## Broadband research: from ideation to report
...
![](assets/images/report_slide.png){height=50%}
...
#### FCC has provided data on ISP's since 2014, but:

  * Each dataset was quite **voluminous** (hundreds of files)

  * No "**guard rails**": multiple encodings, erroneous values (limited QC)
...
## How it started: Manual Extraction ...
...
- [Website](https://ruralinnovation.github.io/cori.data.fcc){.external target="_blank"} to share it/distribute it
...
- Providers competiting in all Ohio are at the Core of the networks

- Providers with few competitors are at the edges

- `cori.data.fcc` support spatial and relation data
