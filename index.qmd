...
## Goals of a Data Package:

:::{.incremental}
1. **Accelerate Innovation**<br />
   Broadband data is packaged so researchers to focus on analysis and insights, not data wrangling.
2. **Address Data Challenges**<br />
   Memorialize low-level data transformations so that subsequent analysis is easy for others to reproduce.
   ... granular detail, essential for understanding rural broadband challenges
3. **Unlock Deeper Insights Faster**<br />
   Packaging data with code simplifies data access, reduces errors, and promotes collaboration.
