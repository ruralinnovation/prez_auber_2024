...
2. Download raw data from CORI (MBM / Form 477)

3. Download tranformed data (NBM) 
...
1. Solved the lack of reactivity: working with primary data does not need to be slow!  

2. Added benefits: lower cost, less contraints on permissions -> share it!

## why sharing it?

Facilitate the access to primary data to researchers, regional economists:  one of CORI's goal is to provide rural community with good internet.

- Open source is :

* Way to publish: Everyone can read the code and contribute

* Way to share: you can use it


## Packaging code: Documentation
  
- What does this function do? -> `?get_nbm_block` / [References](https://ruralinnovation.github.io/cori.data.fcc/reference/index.html)

- How can I integrate those functions in my workflow? [Vignettes/Uses cases](https://ruralinnovation.github.io/cori.data.fcc/reference/index.html)
...
[^emily]: https://www.emilyriederer.com/post/team-of-packages/#collaboration
...
- once data as code is place we can focus on business logic 

## Summary

- data as code:

  * Metadata is hard: moving data as code help with that!
